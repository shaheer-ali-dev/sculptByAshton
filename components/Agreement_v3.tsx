...
`
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let y = 40
      ctx.fillText('SCULPT 6-Month Coaching Agreement', 40, y)
      y += 30
...
const filename = `agreement_${form.clientName.replace(/\s/g,'_')}_${form.date}.png`
...
maxWidth: '100%',
      ...
      <div style={{ padding: 40, overflowY: 'auto', maxHeight: '85vh' }}>
        ...
        <h2 style={{ fontSize: 26, fontWeight: 700, marginBottom: 16 }}>
          SCULPT 6-Month Coaching Agreement
        </h2>
