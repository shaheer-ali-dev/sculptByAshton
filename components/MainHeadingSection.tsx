      ...
      <div className="container mx-auto px-4 sm:px-6 py-4">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h1 className="font-extrabold leading-tight">
            <span className="text-lg sm:text-xl md:text-3xl lg:text-4xl heading-font text-black block">
              THIS ISN&apos;T ABOUT GETTING RESULTS AND FALLING BACK,
            </span>
            <span className="text-lg sm:text-xl md:text-3xl lg:text-4xl heading-font text-[#5A5A5A] block mt-2">
